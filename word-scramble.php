...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    ...
    <body>
    <p class = "large-text centered"> What word am I thinking of? Keep guessing until you solve them all. </div>
    <div class = "container">
        ...
        <div id = "console-container">
            ...
            <div id = "input-form" style="position: relative; top: -60px;">
                <form>
                <input type="text" autofocus="autofocus"> <input type="submit" value="Unscramble!"/>
                </form> 
            </div>
