<?php
 ...
 //    $mysqli->query("INSERT INTO game (id, visits, game, incentive)  VALUES ('$SESSION_ID', '$SESSION_VISITS', '$game_sequence[0]', '$incentive_sequence[0]')");
	// $mysqli->query("INSERT INTO game (id, visits, game, incentive)  VALUES ('$SESSION_ID', '$SESSION_VISITS', '$game_sequence[1]', '$incentive_sequence[1]')");
	// $mysqli->query("INSERT INTO game (id, visits, game, incentive)  VALUES ('$SESSION_ID', '$SESSION_VISITS', '$game_sequence[2]', '$incentive_sequence[2]')");
