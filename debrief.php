...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    ...
    <div class = "container">
        ...
        <p> So we may have been lying a little bit. </p>

        </span>

        <p class = "large-text dark"> <strong>This experiment was not actually about linguistics or anything language-related at all.</strong></p>
